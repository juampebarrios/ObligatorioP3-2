...
namespace DataAccess.Migrations
{
    ...
    [Migration("20220619145058_init9")]
    partial class init9
    {
            ...
            modelBuilder.Entity("Dominio.FichaCuidado", b =>
                {
                    ...
                    b.Property<int?>("miPlantaIdPlanta")
                        .HasColumnType("int");

                    b.HasKey("IdFicha");

                    b.HasIndex("miPlantaIdPlanta");
            ...
            modelBuilder.Entity("Dominio.Planta", b =>
                {
                    ...
                    b.Property<int?>("MiTipoPlantaIdTipoPlanta")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MiTipoPlantaIdTipoPlanta");
            ...
            modelBuilder.Entity("Dominio.PlantaComprada", b =>
                {
                    ...
                    b.Property<int?>("UnaPlantaIdPlanta")
                        .HasColumnType("int");

                    b.Property<int?>("miCompraIdCompra")
                        .HasColumnType("int");

                    b.HasKey("IdPlantaComprada");

                    b.HasIndex("UnaPlantaIdPlanta");

                    b.HasIndex("miCompraIdCompra");
            ...
            modelBuilder.Entity("Dominio.FichaCuidado", b =>
                {
                    b.HasOne("Dominio.Planta", "miPlanta")
                        .WithMany()
                        .HasForeignKey("miPlantaIdPlanta");
                });
            ...
            modelBuilder.Entity("Dominio.Planta", b =>
                {
                    b.HasOne("Dominio.TipoPlanta", "MiTipoPlanta")
                        .WithMany()
                        .HasForeignKey("MiTipoPlantaIdTipoPlanta");
                });
            ...
            modelBuilder.Entity("Dominio.PlantaComprada", b =>
                {
                    b.HasOne("Dominio.Planta", "UnaPlanta")
                        .WithMany()
                        .HasForeignKey("UnaPlantaIdPlanta");

                    b.HasOne("Dominio.Compra", "miCompra")
                        .WithMany("PlantasCompradas")
                        .HasForeignKey("miCompraIdCompra");
                });
